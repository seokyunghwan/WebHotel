    ...
    */
	...
	function init()	{
		if (!ns4){
			...
			sHTML1="<span id='spanYear' style='padding-left:55px;border-width:0;cursor:pointer' onmouseover='swapImage(\"changeYear\",\"../image/drop2.gif\");window.status=\""+selectYearMessage+"\"' onmouseout='swapImage(\"changeYear\",\"../image/drop1.gif\");window.status=\"\"' onclick='popUpYear()'></span>&nbsp;";
...
//			sHTML1+="<span id='spanLeft'	style='border-width:0;cursor:pointer' onmouseover='swapImage(\"changeLeft\",\"left2.gif\");window.status=\""+scrollLeftMessage+"\"' onclick='javascript:decMonth()' onmouseout='clearInterval(intervalID1);swapImage(\"changeLeft\",\"left1.gif\");window.status=\"\"' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartDecMonth()\",500)' onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp<IMG id='changeLeft' SRC='"+imgDir+"left1.gif' width=10 height=11 BORDER=0>&nbsp</span>&nbsp;";
			...
			sHTML1+="<span id='spanMonth' style='padding-left:20px;border-width:0;cursor:pointer'	onmouseover='swapImage(\"changeMonth\",\"../image/drop2.gif\");window.status=\""+selectMonthMessage+"\"' onmouseout='swapImage(\"changeMonth\",\"../image/drop1.gif\");window.status=\"\"' onclick='popUpMonth()'></span>&nbsp;";
			// link to next month 
...
//		var	sTmp;
   ...
   function WeekNbr(n) {
	...
	function constructCalendar() {
		...
		document.getElementById("spanMonth").innerHTML = "&nbsp;" +	monthName[monthSelected] + "&nbsp;<IMG id='changeMonth' SRC='"+imgDir+"../image/drop1.gif' WIDTH='12' HEIGHT='10' BORDER=0>";
		document.getElementById("spanYear").innerHTML =	"&nbsp;" + yearSelected	+ "&nbsp;<IMG id='changeYear' SRC='"+imgDir+"../image/drop1.gif' WIDTH='12' HEIGHT='10' BORDER=0>";
	}
